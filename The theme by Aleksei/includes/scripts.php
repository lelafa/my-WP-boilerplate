...
function scripts_styles()
{
	...
	wp_enqueue_script( 'scripts', $temp_dir . '/assets/js/scripts.js', [ 'jquery', 'swiper-scripts' ], $ver, true );
	
	// Ajax
	wp_enqueue_script( 'ajax', $temp_dir . '/assets/js/ajax.js', [ 'jquery', 'select2-scripts' ], $ver, true );
